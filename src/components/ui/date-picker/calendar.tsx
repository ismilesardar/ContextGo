  ...
  (
    ...
    return (
      <button
        ...
        disabled={disabled}
        className={cn(
          'flex size-7 shrink-0 items-center justify-center rounded border p-1 transition outline-none select-none',
          'border-neutral-200 text-neutral-600 hover:text-neutral-800 dark:text-neutral-300',
          ...
          return (
            <div className='flex items-center justify-between'>
              ...
              <div
                role='presentation'
                aria-live='polite'
                className='text-sm font-medium text-neutral-900 capitalize tabular-nums dark:text-neutral-300'
              >
