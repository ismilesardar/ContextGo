                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 10px;"><strong>Note:</strong> This link will expire in 8 hours. If you did not create an account, you can safely ignore this email.</p>
                                                                         
                                                                    <p style="margin: 0;">Thank you,<br />
                                                                        <a href="https://shibsa.com/"
                                                                            target="_blank">shibsa</a>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
