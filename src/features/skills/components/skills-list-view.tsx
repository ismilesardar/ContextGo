...
export function SkillsListView({
  ...
  return (
    <PageShell
      title='Skills'
      description='Reusable workflows and SOPs — code review, deployment, and task execution guides every team member and AI tool can follow.'
      showDate={false}
      actions={
        canManage && (
        ...
        <div className='flex flex-col items-center justify-center rounded-2xl border border-dashed border-neutral-300 p-16 text-center dark:border-neutral-700'>
          ...
          <p className='text-muted-foreground text-sm'>
            {hasActiveFilter
              ...
              : 'No Skills yet. Create your first Skill to document important project knowledge.'}
          </p>
