...
import {
  useChecklistVersions,
  useSetMainChecklistVersion,
  useDeleteChecklistVersion
} from '../utils/use-checklists';

export function ChecklistVersionHistoryModal({
  projectId,
  checklistId,
  canManage,
  showModal,
  ...
  const { data, isLoading } = useChecklistVersions(projectId, checklistId);
  const setMainVersion = useSetMainChecklistVersion(projectId, checklistId);
  const deleteVersion = useDeleteChecklistVersion(projectId, checklistId);
                  ...
                  <Button
                    ...
                    title={
                      isSelectedMain
                        ...
                        : versions.length <= 1
                          ? 'A checklist must always have at least one version'
                          : undefined
                    }
