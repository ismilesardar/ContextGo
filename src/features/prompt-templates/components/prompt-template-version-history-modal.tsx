...
import {
  ...
  useSetMainPromptTemplateVersion,
  useDeletePromptTemplateVersion
} from '../utils/use-prompt-templates';

export function PromptTemplateVersionHistoryModal({
  projectId,
  promptTemplateId,
  canManage,
  showModal,
  ...
  const { data, isLoading } = usePromptTemplateVersions(
    projectId,
    promptTemplateId
  );
  const setMainVersion = useSetMainPromptTemplateVersion(
    projectId,
    promptTemplateId
  );
  const deleteVersion = useDeletePromptTemplateVersion(
    projectId,
    promptTemplateId
  );
                  ...
                  <Button
                    ...
                    title={
                      isSelectedMain
                        ...
                        : versions.length <= 1
                          ? 'A promptTemplate must always have at least one version'
                          : undefined
                    }
