        ...
        {presets.map((preset, index) => {
          return (
            <Command.Item
              ...
              value={preset.id}
              className={cn(
                'group relative flex cursor-pointer items-center justify-between overflow-hidden rounded border border-neutral-200 text-ellipsis whitespace-nowrap',
                'px-2.5 py-1.5 text-left text-sm text-neutral-700 shadow-sm outline-none sm:w-full sm:border-none sm:py-2 sm:shadow-none dark:text-neutral-400',
                'disabled:pointer-events-none disabled:opacity-50',
                'sm:data-[selected=true]:bg-neutral-100 sm:data-[selected=true]:dark:bg-neutral-800',
            ...
            >
              ...
              {preset.requiresUpgrade ? (
                ...
                <kbd className='text-neutral-4000 hidden rounded bg-neutral-100 px-2 py-0.5 text-xs font-light group-data-[selected=true]:bg-neutral-200 md:block dark:bg-neutral-700'>
