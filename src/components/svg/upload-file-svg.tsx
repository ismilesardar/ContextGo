...
const UploadFileSvg = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    height={18}
    width={18}
    viewBox='0 0 18 18'
    xmlns='http://www.w3.org/2000/svg'
    className='size-5 scale-100 text-neutral-500 transition-all duration-75 group-hover:scale-110 group-active:scale-95'
    {...props}
  >
    <g fill='currentColor'>
      <path
