...
import {
  useInstructionVersions,
  useSetMainInstructionVersion,
  useDeleteInstructionVersion
} from '../utils/use-instructions';

export function InstructionVersionHistoryModal({
  projectId,
  instructionId,
  canManage,
  showModal,
  ...
  const { data, isLoading } = useInstructionVersions(projectId, instructionId);
  const setMainVersion = useSetMainInstructionVersion(projectId, instructionId);
  const deleteVersion = useDeleteInstructionVersion(projectId, instructionId);
                  ...
                  <Button
                    ...
                    title={
                      isSelectedMain
                        ...
                        : versions.length <= 1
                          ? 'A instruction must always have at least one version'
                          : undefined
                    }
