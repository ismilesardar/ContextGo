...
import {
  useContextVersions,
  useSetMainContextVersion,
  useDeleteContextVersion
} from '../utils/use-contexts';

export function ContextVersionHistoryModal({
  projectId,
  contextId,
  canManage,
  showModal,
  ...
  const { data, isLoading } = useContextVersions(projectId, contextId);
  const setMainVersion = useSetMainContextVersion(projectId, contextId);
  const deleteVersion = useDeleteContextVersion(projectId, contextId);
                  ...
                  <Button
                    ...
                    title={
                      isSelectedMain
                        ...
                        : versions.length <= 1
                          ? 'A context must always have at least one version'
                          : undefined
                    }
